#This script acts as a server that listens on the port specified from the first argument or defaults to 8000. It responds to any request with a string following the HTTP protocol with code 200 and a basic HTML containing only the word 'READY'
